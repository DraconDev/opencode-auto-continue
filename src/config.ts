...
export const DEFAULT_CONFIG: PluginConfig = {
  ...
  continueWithPlanMessage: "You were creating a plan. Finish the plan and start executing the first item. Do not stop to ask for confirmation.",
  continueMessage: "Continue from where you left off. Do not ask for permission — just proceed with the next step.",
  continueWithTodosMessage: "Continue from where you left off. You have {pending} open task(s): {todoList}. Work through these tasks. Create additional todos for any new work you discover. Do not ask for permission or confirmation.",
  ...
  reviewMessage: "All tracked tasks are marked complete. Now verify everything works: run the test suite and check for lint or build errors. Create fix todos for any bugs or failures you find. If you have planned work that isn't tracked yet, create todos for it now and continue working. Keep working until everything passes. Do not stop until all tests are green.",
  reviewDebounceMs: 500,
  showToasts: true,
  nudgeEnabled: true,
  nudgeIdleDelayMs: 500,
  nudgeMaxSubmits: 3,
  nudgeMessage: "Continue working on the pending tasks and mark them as completed when done. Create additional todos for any new work you discover, including planned work from earlier that isn't tracked yet. Do not ask for permission — act autonomously and keep making progress. Pending tasks: {todoList}.",
