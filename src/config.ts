...
export const DEFAULT_CONFIG: PluginConfig = {
  ...
  reviewMessage: "All tracked tasks are marked complete. Now verify everything works: run the test suite and check for lint or build errors. **Create fix todos for any bugs or failures you find before attempting fixes.** If you have planned work that isn't tracked yet, **create todos for it now** and then work through them. Keep working until everything passes. Do not stop until all tests are green.",
