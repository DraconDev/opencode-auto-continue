...
export const DEFAULT_CONFIG: PluginConfig = {
  ...
  reviewMessage: "All tracked tasks are marked complete. Now verify everything works: run the test suite (e.g., `npm test`, `cargo test`, `go test`) and check for lint or build errors. Create fix todos for any bugs, issues, or failures you find. Keep working until everything passes. Do not stop until all tests are green.",
  reviewDebounceMs: 500,
  showToasts: true,
  nudgeEnabled: true,
  nudgeIdleDelayMs: 500,
  nudgeMaxSubmits: 3,
  nudgeMessage: "Continue working on the pending tasks and mark them as completed when done. Create additional todos for any new work you discover. Do not ask for permission — act autonomously and keep making progress. Pending tasks: {todoList}.",
